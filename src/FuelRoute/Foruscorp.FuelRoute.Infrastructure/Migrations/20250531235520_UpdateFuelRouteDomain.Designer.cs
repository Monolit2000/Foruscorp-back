...
namespace Foruscorp.FuelRoutes.Infrastructure.Migrations
{
    ...
    [Migration("20250531235520_UpdateFuelRouteDomain")]
    partial class UpdateFuelRouteDomain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foruscorp.FuelRoutes.Domain.FuelRoutes.FuelRoute", b =>
                {
                    b.OwnsMany("Foruscorp.FuelRoutes.Domain.FuelRoutes.RouteFuelStation", "FuelPoints", b1 =>
                        {
                            ...
                            b1.OwnsOne("Foruscorp.FuelRoutes.Domain.FuelRoutes.GeoPoint", "Location", b2 =>
                                {
                                    b2.Property<Guid>("RouteFuelStationFuelPointId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("RouteFuelStationFuelPointId");

                                    b2.ToTable("RouteFuelPoints", "FuelRoutes");

                                    b2.WithOwner()
                                        .HasForeignKey("RouteFuelStationFuelPointId");
                                });

                            b1.Navigation("Location");
                        });

                    b.OwnsMany("Foruscorp.FuelRoutes.Domain.FuelRoutes.RouteSection", "RouteSections", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid");

...
namespace Foruscorp.TrucksTracking.Infrastructure.Migrations
{
    ...
    [Migration("20250628225717_Update_TruckTrackers_Domain")]
    partial class Update_TruckTrackers_Domain
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Foruscorp.TrucksTracking.Domain.Trucks.TruckFuel", b =>
                {
                    ...
                    b.Property<decimal>("NewFuelLevel")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PreviousFuelLevel")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.OwnsOne("Foruscorp.TrucksTracking.Domain.Trucks.GeoPoint", "Location", b1 =>
                        {
                            ...
                            b1.HasKey("TruckFuelId");

                            b1.ToTable("TruckFuelHistory", "TuckTracking");

                            b1.WithOwner()
                                .HasForeignKey("TruckFuelId");
                        });

...
using Foruscorp.Trucks.Aplication.DriverBonuses.CalculateBonuses;

namespace Foruscorp.Trucks.Aplication.Transactions
{
    ...
    public class ParsePdfTransactionsCommandHandler : IRequestHandler<ParsePdfTransactionsCommand, Result<List<TransactionDto>>>
    {
        ...
        public ParsePdfTransactionsCommandHandler(
            ...
            ITruckContext truckTrackingContext,
            ISender sender)
        {
        ...
        {
            var reportLoadAttempt = ReportLoadAttempt.CreateNew(1); 
            ...
            try
            {
                ...
                await _sender.Send(new CalculateBonusesCommand(transactions.Select(t => t.Id).ToList()));
